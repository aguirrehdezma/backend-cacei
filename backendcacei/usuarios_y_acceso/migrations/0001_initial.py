    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrador'), ('coordinador', 'Coordinador'), ('docente', 'Docente')], default='docente', help_text='Rol del usuario en el sistema', max_length=20)),
