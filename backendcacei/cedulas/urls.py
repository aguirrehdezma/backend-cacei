...
from cedulas.views import CedulaCVSinteticoView, CedulaHerramientasValoracionAEPView, CedulaPlanMejoraView, CedulaProgramacursoasignaturaView, CedulaValoracionObjetivosView, CedulaOrganizacionCurricularView
