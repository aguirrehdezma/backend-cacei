...
from gestion_academica.views import BibliografiaViewSet, CriterioDesempenoViewSet, CursoViewSet, EstrategiaEnsenanzaViewSet, EstrategiaEvaluacionViewSet, HorasSemanaViewSet, ObjetivoEducacionalViewSet, ProductoAcademicoViewSet, ProgramaEducativoViewSet, UnidadTematicaViewSet
